...
public class TemperatureDetailsFragment extends BaseFragment {
    ...
    public static TemperatureDetailsFragment getInstance(String deviceId, String deviceNo){

        TemperatureDetailsFragment fragment = new TemperatureDetailsFragment();
